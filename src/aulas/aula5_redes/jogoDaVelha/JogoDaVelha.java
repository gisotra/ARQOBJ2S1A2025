package aulas.aula5_redes.jogoDaVelha;
...
public class JogoDaVelha {
    ...
    /*---------- ATRIBUTOS ----------*/
    private Scanner console; //inputs
    
    private String[][] tabuleiro;
    private boolean fim; //true | false
    ...
    private boolean suaVez; //true | false

    /*---------- CONSTRUTOR ----------*/ 
    public JogoDaVelha() throws Exception {
        
        console = new Scanner(System.in); //inicializa o scanner 
        
        tabuleiro = new String[3][3]; //inicializa o tabuleiro
    ...
    public void iniciar() { //tabuleiro settado como "vazio"
